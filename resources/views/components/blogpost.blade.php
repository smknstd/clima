<div class="p-4 md:w-1/3">
    <a href="{{ route('blogpost', [$blogpost]) }}">
        <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
            <img class="lg:h-48 md:h-36 w-full object-cover object-center" src="{{ $blogpost->cover ? $blogpost->cover->thumbnail(700) : asset('/img/default-blogpost.jpg') }}" alt="photo d'illustration de l'article">
            <div class="p-6">

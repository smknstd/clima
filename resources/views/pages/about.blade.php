<x-layout class="home">
    ...
    <x-slot name="meta_description">
        Passion de la météorologie, climatologie et photographie en Alsace-Moselle
    </x-slot>
    ...
    <x-slot name="content">
        ...
        <section class="text-gray-600 body-font">
            <div class="container mx-auto flex px-5 py-24 items-center justify-center flex-col">
                <img class="lg:w-3/6 md:w-3/6 w-5/6 mb-10 object-cover object-center rounded-lg" alt="photo des membres de l'association" src="{{ asset('/img/association.jpg') }}">
